...
class _FavoriteListScreenState extends State<FavoriteListScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        child: _favorites.isEmpty ? _emptyState() : _listState(),
      ),
    );
  }
  ...
  Widget _listState() {
    return Column(
      ...
      children: [
        ...
        ..._favorites.map(_favoriteCard),
      ],
    );
  }

  Widget _favoriteCard(_FavoriteItem item) {
    return Container(
  ...
  void _showDeleteDialog(_FavoriteItem item) {
    showDialog<void>(
      context: context,
      builder: (_) => Dialog(

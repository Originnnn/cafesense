...
class CafeSenseApp extends StatefulWidget {
  const CafeSenseApp({super.key});

  @override
  State<CafeSenseApp> createState() => _CafeSenseAppState();
}

class _CafeSenseAppState extends State<CafeSenseApp> {
  // Quản lý trạng thái Sáng/Tối toàn ứng dụng
  ...
  ThemeData _buildTheme(Brightness brightness) {
    ...
    return ThemeData(
      ...
      scaffoldBackgroundColor: isDark ? const Color(0xFF121212) : const Color(0xFFFBF8F5),
      useMaterial3: true,
      // Cấu hình màu sắc chủ đạo dựa trên thiết kế
